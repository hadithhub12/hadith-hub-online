...
import { useFont, type ArabicFont, type FontSize, ARABIC_FONTS, FONT_SIZES } from '@/context/FontContext';
...
export default function FontSelector({ language = 'ar' }: FontSelectorProps) {
  const { font, fontSize, setFont, setFontSize, fonts, fontSizes, currentFontSize } = useFont();
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute left-0 sm:right-0 sm:left-auto mt-2 w-72 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden">
            {/* Tabs */}
